...
const makeMusicCard = (id: string, data: TobipoData, isTobipo: boolean) => {
  return (
    <div
      className=
    ...
    >
      ...
      <a className="music-card-href"
        href={isTobipo ? `./${id}` : data.external_urls_spotify}
      ...
      {isTobipo &&
        ...
        >
          <TwitterIcon style={{
            ...
            onClick={() => makeTweet(data.songName, data.artist, id)}
          />
        </div>
      }
